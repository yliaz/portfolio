  ...
  tutorialSideBar: [
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tutorial/01-github-profile', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tutorial/02-docusaurus', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tutorial/03-macbook', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tutorial/04-notion', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'autogenerated',
          dirName: 'tutorial/05-magic-cube', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
        },
      ],
    }
  ],
      ...
      items: [
        {
          ...
          items: [
            {
              type: 'autogenerated',
              dirName: 'interview/frontend/01-html', // '.' 指的是当前的 docs 目录（也就是存放文档的根目录）
            },
          ]
        }
      ],

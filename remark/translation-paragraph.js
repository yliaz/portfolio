...
module.exports = function plugin (classNames = {}) {
  ...
  function alignTokenizer (eat, value, silent) {
    ...
    if (startMarker === '<~' && endMarker === '<~') {
      elementType = 'chineseParagraph'
      classes = classNames.first ? classNames.first : 'chinese-paragraph'
    }
    if (startMarker === '~>' && endMarker === '~>') {
      elementType = 'englishParagraph'
      classes = classNames.last ? classNames.last : 'english-paragraph'
    }
  ...
  if (Compiler) {
    ...
    visitors.chinese = alignCompiler
    visitors.english = alignCompiler
  }
}